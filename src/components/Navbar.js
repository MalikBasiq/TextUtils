...
import PropTypes from 'prop-types'; // protype ko declare karne k liat isko import karte v.imp end pe types define ki props ki
import { Link } from 'react-router-dom';
export default function Navbar(props) {
  return (


    /* is props ko khabi b edit nahi karte is file me idher sirf get karte*/
    /*props sirf READ-ONLY honge yahan*/
